...
<nav class="navbar navbar-light navbar-expand-lg bg-dark fixed-top text-white" style="height:5em">
    ...
    <div class="collapse navbar-collapse" style="font-size: 20px" id="my-nav">
        ...
        <a class="nav-link text-white" href="/servletPaymentsApp/payment/page?pageNum=${requestScope.curPage}&sortParam=${requestScope.sortParameter}&lang=en">
            <fmt:message key="lang.en"/>
        </a>
        <a class="nav-link text-white" href="/servletPaymentsApp/payment/page?pageNum=${requestScope.curPage}&sortParam=${requestScope.sortParameter}&lang=ua">
