...
public class ShowAllPaymentsCommand implements Command {
    ...
    public ShowAllPaymentsCommand(PaymentService paymentService) {
    ...
    public String execute(HttpServletRequest request) {
        ...
        List<Payment> payments = paymentService.getAllPaymentsPage(0, "none");
